...
import { Zap, Code, ShieldCheck, Users, BarChart, MonitorPlay, BrainCircuit, FileText, CalendarCheck, ArrowRight, Star, ChevronLeft, ChevronRight, Terminal, Sun, Moon } from 'lucide-react';
...
export function Landing() {
  ...
  return (
    <div className="min-h-screen font-sans">
      ...
      {/* Hero Section - Updated to center content without image and use primarily two colors */}
      <section className="hero min-h-[calc(100vh-4rem)] bg-base-200">
        <div className="hero-content flex-col container mx-auto py-16 text-center max-w-4xl">
          <div className="badge badge-primary py-3 px-4 font-semibold animate-bounce-slow">🚀 AI-Powered Interviews</div>
          ...
          <div className="join shadow-lg my-4">
            ...
            <button className="btn btn-outline btn-primary join-item">Watch Demo</button>
          </div>
      ...
      <section className="py-20 bg-base-100">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
             <div className="badge badge-primary badge-outline p-3 mb-4">CORE FEATURES</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Feature Card 1 */}
            <div className="card bg-base-200 shadow-md hover:shadow-xl transition-all duration-300 hover:scale-[1.02] border border-transparent hover:border-primary/30 group">
            ...
            {/* Feature Card 2 */}
             <div className="card bg-base-200 shadow-md hover:shadow-xl transition-all duration-300 hover:scale-[1.02] border border-transparent hover:border-secondary/30 group">
              <figure className="px-10 pt-10">
                 <div className="avatar placeholder">
      ...
      <section className="py-20 bg-base-200">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
             <div className="badge badge-secondary p-3 mb-4">ASSESSMENT TYPES</div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {/* Card 1 */}
            <div className="card bg-primary text-primary-content shadow-md hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
            ...
            {/* Card 2 */}
            <div className="card bg-secondary text-secondary-content shadow-md hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              <div className="card-body">
                <div className="flex items-center gap-3 mb-2">
                  <Zap size={24} />
      ...
      <section className="py-20 bg-base-100">
        <div className="container mx-auto px-4">
          ...
          <div className="relative mx-auto max-w-3xl">
            <div className="carousel w-full rounded-lg bg-base-200 max-w-3xl mx-auto min-h-[26rem]">
              {/* Testimonial 1 */}
            ...
            <div className="flex justify-center gap-2 mt-4">
              <a href="#slide1" onClick={handleNavClick} className="btn btn-xs btn-circle btn-primary">1</a> 
